package com.social.network.authservice.config;
...
import com.social.network.authservice.oauth2.SnTokenEnhancer;
import com.social.network.authservice.service.SnUserDetailsService;
